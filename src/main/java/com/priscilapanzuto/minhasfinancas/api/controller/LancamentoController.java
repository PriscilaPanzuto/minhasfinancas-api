...
import com.priscilapanzuto.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.priscilapanzuto.minhasfinancas.api.dto.LancamentoDTO;
	...
	public ResponseEntity atualizarStatus( @PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto) {
		return service.buscarPorId(id).map( entidade -> {
			...
			if(statusSelecionado ==null) {
				return ResponseEntity.badRequest().body("Não foi possível alterar seu status de lançamento, insira um status válido.");
			}
